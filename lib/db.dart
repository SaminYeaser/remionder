...
class NotesDatabase{
  static final NotesDatabase instance = NotesDatabase._init_();

  static Database? _database;
  NotesDatabase._init_();

  Future<Database> get database async{
    if(_database != null) return _database!;

    _database = await _initDB('noteDB');
    return _database!;
  }
  ...
  ${NoteFields.description} $boolType,
  ${NoteFields.time} $numberType,
  )
  ''');
  }
